...
`,Y=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:e,children:f,toasterId:g,containerStyle:h,containerClassName:i})=>{let{toasts:j,handlers:k}=((a,b="default")=>{let{toasts:d,pausedAt:e}=((a={},b=t)=>{let[d,e]=(0,c.useState)(x[b]||w),f=(0,c.useRef)(x[b]);(0,c.useEffect)(()=>(f.current!==x[b]&&e(x[b]),v.push([b,e]),()=>{let a=v.findIndex(([a])=>a===b);a>-1&&v.splice(a,1)}),[b]);let g=d.toasts.map(b=>{var c,d,e;return{...a,...a[b.type],...b,removeDelay:b.removeDelay||(null==(c=a[b.type])?void 0:c.removeDelay)||(null==a?void 0:a.removeDelay),duration:b.duration||(null==(d=a[b.type])?void 0:d.duration)||(null==a?void 0:a.duration)||B[b.type],style:{...a.style,...null==(e=a[b.type])?void 0:e.style,...b.style}}});return{...d,toasts:g}})(a,b),f=(0,c.useRef)(new Map).current,g=(0,c.useCallback)((a,b=E)=>{if(f.has(a))return;let c=setTimeout(()=>{f.delete(a),h({type:4,toastId:a})},b);f.set(a,c)},[]);(0,c.useEffect)(()=>{if(e)return;let a=Date.now(),c=d.map(c=>{if(c.duration===1/0)return;let d=(c.duration||0)+c.pauseDuration-(a-c.createdAt);if(d<0){c.visible&&D.dismiss(c.id);return}return setTimeout(()=>D.dismiss(c.id,b),d)});return()=>{c.forEach(a=>a&&clearTimeout(a))}},[d,e,b]);let h=(0,c.useCallback)(A(b),[b]),i=(0,c.useCallback)(()=>{h({type:5,time:Date.now()})},[h]),j=(0,c.useCallback)((a,b)=>{h({type:1,toast:{id:a,height:b}})},[h]),k=(0,c.useCallback)(()=>{e&&h({type:6,time:Date.now()})},[e,h]),l=(0,c.useCallback)((a,b)=>{let{reverseOrder:c=!1,gutter:e=8,defaultPosition:f}=b||{},g=d.filter(b=>(b.position||f)===(a.position||f)&&b.height),h=g.findIndex(b=>b.id===a.id),i=g.filter((a,b)=>b<h&&a.visible).length;return g.filter(a=>a.visible).slice(...c?[i+1]:[0,i]).reduce((a,b)=>a+(b.height||0)+e,0)},[d]);return(0,c.useEffect)(()=>{d.forEach(a=>{if(a.dismissed)g(a.id,a.removeDelay);else{let b=f.get(a.id);b&&(clearTimeout(b),f.delete(a.id))}})},[d,g]),{toasts:d,handlers:{updateHeight:j,startPause:i,endPause:k,calculateOffset:l}}})(d,g);return c.createElement("div",{"data-rht-toaster":g||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...h},className:i,onMouseEnter:k.startPause,onMouseLeave:k.endPause},j.map(d=>{let g=d.position||b,h=((a,b)=>{let c=a.includes("top"),d=a.includes("center")?{justifyContent:"center"}:a.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:s()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${b*(c?1:-1)}px)`,...c?{top:0}:{bottom:0},...d}})(g,k.calculateOffset(d,{reverseOrder:a,gutter:e,defaultPosition:b}));return c.createElement(W,{id:d.id,key:d.id,onHeightUpdate:k.updateHeight,className:d.visible?X:"",style:h},"custom"===d.type?q(d.message,d):f?f(d):c.createElement(V,{toast:d,position:g}))}))},Z=D},3987,a=>{"use strict";a.s(["default",()=>g]);var b=a.i(87924),c=a.i(72131),d=a.i(38246),e=a.i(50944),f=a.i(6704);let g=()=>{let a=(0,e.useRouter)(),[g,h]=(0,c.useState)({phoneNumber:"",rememberMe:!1}),[i,j]=(0,c.useState)(!1),[k,l]=(0,c.useState)(0),m=["/images/pexels-binyaminmellish-106399.jpg","/images/istockphoto-1165384568-612x612.jpg","/images/istockphoto-1465618017-612x612.jpg","/images/realestate2.jpg"],n=[{text:"Finding the perfect property has never been easier. This platform connects us with verified brokers and premium properties, making our dream home search seamless and successful.",author:"Sarah Johnson",role:"Property Owner"},{text:"As a real estate broker, this platform has transformed how I connect with clients and showcase properties. The streamlined process and professional tools have significantly boosted my business success.",author:"Michael Chen",role:"Real Estate Broker"},{text:"The property search experience is exceptional. From luxury villas to commercial spaces, we found exactly what we were looking for with the help of verified brokers on this platform.",author:"Priya Sharma",role:"Business Owner"},{text:"This platform made our investment journey smooth and transparent. The verified brokers and detailed property information helped us make informed decisions for our real estate portfolio.",author:"David Wilson",role:"Real Estate Investor"}];(0,c.useEffect)(()=>{let a=setInterval(()=>{l(a=>(a+1)%m.length)},3e3);return()=>clearInterval(a)},[m.length]);let o=async b=>{if(b.preventDefault(),g.phoneNumber?!!/^\d{10}$/.test(g.phoneNumber.replace(/\D/g,""))||(f.default.error("Please enter a valid 10-digit phone number"),!1):(f.default.error("Phone number is required"),!1)){j(!0);try{let b="https://broker-adda-be.algofolks.com/api/auth/login",c=await fetch(b,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:g.phoneNumber})}),d=await c.json();c.ok&&(void 0===d.success||!0===d.success)?(f.default.success("Login successful! Redirecting..."),a.push(`/verify-code?phone=${encodeURIComponent(g.phoneNumber)}`)):(console.error("Login failed:",{url:b,status:c.status,data:d}),f.default.error(d.message||`Login failed (${c.status})`))}catch(a){console.error("Login network error:",a),f.default.error("Network error. Please try again.")}finally{j(!1)}}};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(f.Toaster,{position:"top-right",toastOptions:{duration:4e3,style:{background:"#363636",color:"#fff"},success:{duration:3e3,iconTheme:{primary:"#4ade80",secondary:"#fff"}},error:{duration:4e3,iconTheme:{primary:"#ef4444",secondary:"#fff"}}}}),(0,b.jsxs)("div",{className:"min-h-screen p-6  flex",children:[(0,b.jsx)("div",{className:"flex-1 flex items-center justify-center px-6  bg-white",children:(0,b.jsxs)("div",{className:"w-full max-w-md",children:[(0,b.jsxs)("div",{className:"mb-8",children:[(0,b.jsx)("h1",{className:"text-3xl font-bold text-gray-900 mb-2",children:"Login"}),(0,b.jsx)("p",{className:"text-gray-600",children:"Please fill your detail to access your account."})]}),(0,b.jsxs)("form",{onSubmit:o,className:"space-y-6",autoComplete:"off",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{htmlFor:"phoneNumber",className:"block text-sm font-medium text-gray-900 mb-2",children:"Phone Number *"}),(0,b.jsx)("input",{type:"tel",id:"phoneNumber",name:"phoneNumber",value:g.phoneNumber,onChange:a=>{let{name:b,value:c,type:d,checked:e}=a.target;h(a=>({...a,[b]:"checkbox"===d?e:c}))},autoComplete:"off",autoCorrect:"off",autoCapitalize:"none",spellCheck:!1,className:"w-full px-4 py-3 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors",placeholder:"Enter Phone Number"})]}),(0,b.jsx)("button",{type:"submit",disabled:i,className:"w-full bg-green-900 text-white py-3 px-4 rounded-full font-medium hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",children:i?"Logging In...":"Login"}),(0,b.jsx)("div",{className:"text-center",children:(0,b.jsxs)("p",{className:"text-gray-600",children:["Don't have an account?"," ",(0,b.jsx)(d.default,{href:"/signup",className:"text-green-900 hover:text-green-900 font-medium",children:"Sign Up"})]})})]})]})}),(0,b.jsx)("div",{className:"hidden lg:flex lg:flex-1 justify-center items-center",children:(0,b.jsxs)("div",{className:"w-[650px] h-[800px] rounded-2xl overflow-hidden relative bg-gradient-to-br from-green-400 to-green-600 flex-shrink-0",children:[(0,b.jsx)("img",{src:m[k],alt:"Real Estate Property",className:"w-[650px] h-[800px] object-cover transition-all duration-500 ease-in-out",onError:a=>{a.target.style.display="none",a.target.nextElementSibling.style.display="flex"}}),(0,b.jsx)("div",{className:"absolute bottom-20 left-1/2 -translate-x-1/2 z-10",children:(0,b.jsxs)("div",{className:" bg-opacity-30 backdrop-blur-lg border border-white border-opacity-50 rounded-2xl p-6 w-[600px] shadow-2xl",children:[(0,b.jsxs)("p",{className:"text-white text-base leading-relaxed mb-4 font-medium",children:['"',n[k].text,'"']}),(0,b.jsxs)("div",{className:"space-y-1",children:[(0,b.jsx)("h4",{className:"text-white font-semibold text-base",children:n[k].author}),(0,b.jsx)("p",{className:"text-white text-sm opacity-90",children:n[k].role})]})]})}),(0,b.jsx)("div",{className:"absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2 z-10",children:m.map((a,c)=>(0,b.jsx)("div",{className:`w-32 h-2 rounded-full flex-shrink-0 cursor-pointer transition-all duration-300 ${k===c?"bg-orange-400":"bg-white bg-opacity-20 backdrop-blur-md"}`,onClick:()=>l(c)},c))})]})})]})]})}}];

//# sourceMappingURL=_c8639a09._.js.map