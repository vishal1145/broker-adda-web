...
`,Y=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:e,children:f,toasterId:g,containerStyle:h,containerClassName:i})=>{let{toasts:j,handlers:k}=((a,b="default")=>{let{toasts:d,pausedAt:e}=((a={},b=t)=>{let[d,e]=(0,c.useState)(x[b]||w),f=(0,c.useRef)(x[b]);(0,c.useEffect)(()=>(f.current!==x[b]&&e(x[b]),v.push([b,e]),()=>{let a=v.findIndex(([a])=>a===b);a>-1&&v.splice(a,1)}),[b]);let g=d.toasts.map(b=>{var c,d,e;return{...a,...a[b.type],...b,removeDelay:b.removeDelay||(null==(c=a[b.type])?void 0:c.removeDelay)||(null==a?void 0:a.removeDelay),duration:b.duration||(null==(d=a[b.type])?void 0:d.duration)||(null==a?void 0:a.duration)||B[b.type],style:{...a.style,...null==(e=a[b.type])?void 0:e.style,...b.style}}});return{...d,toasts:g}})(a,b),f=(0,c.useRef)(new Map).current,g=(0,c.useCallback)((a,b=E)=>{if(f.has(a))return;let c=setTimeout(()=>{f.delete(a),h({type:4,toastId:a})},b);f.set(a,c)},[]);(0,c.useEffect)(()=>{if(e)return;let a=Date.now(),c=d.map(c=>{if(c.duration===1/0)return;let d=(c.duration||0)+c.pauseDuration-(a-c.createdAt);if(d<0){c.visible&&D.dismiss(c.id);return}return setTimeout(()=>D.dismiss(c.id,b),d)});return()=>{c.forEach(a=>a&&clearTimeout(a))}},[d,e,b]);let h=(0,c.useCallback)(A(b),[b]),i=(0,c.useCallback)(()=>{h({type:5,time:Date.now()})},[h]),j=(0,c.useCallback)((a,b)=>{h({type:1,toast:{id:a,height:b}})},[h]),k=(0,c.useCallback)(()=>{e&&h({type:6,time:Date.now()})},[e,h]),l=(0,c.useCallback)((a,b)=>{let{reverseOrder:c=!1,gutter:e=8,defaultPosition:f}=b||{},g=d.filter(b=>(b.position||f)===(a.position||f)&&b.height),h=g.findIndex(b=>b.id===a.id),i=g.filter((a,b)=>b<h&&a.visible).length;return g.filter(a=>a.visible).slice(...c?[i+1]:[0,i]).reduce((a,b)=>a+(b.height||0)+e,0)},[d]);return(0,c.useEffect)(()=>{d.forEach(a=>{if(a.dismissed)g(a.id,a.removeDelay);else{let b=f.get(a.id);b&&(clearTimeout(b),f.delete(a.id))}})},[d,g]),{toasts:d,handlers:{updateHeight:j,startPause:i,endPause:k,calculateOffset:l}}})(d,g);return c.createElement("div",{"data-rht-toaster":g||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...h},className:i,onMouseEnter:k.startPause,onMouseLeave:k.endPause},j.map(d=>{let g=d.position||b,h=((a,b)=>{let c=a.includes("top"),d=a.includes("center")?{justifyContent:"center"}:a.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:s()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${b*(c?1:-1)}px)`,...c?{top:0}:{bottom:0},...d}})(g,k.calculateOffset(d,{reverseOrder:a,gutter:e,defaultPosition:b}));return c.createElement(W,{id:d.id,key:d.id,onHeightUpdate:k.updateHeight,className:d.visible?X:"",style:h},"custom"===d.type?q(d.message,d):f?f(d):c.createElement(V,{toast:d,position:g}))}))},Z=D},32659,a=>{"use strict";a.s(["default",()=>f]);var b=a.i(87924),c=a.i(72131),d=a.i(83490),e=a.i(6704);let f=()=>{let[a,f]=(0,c.useState)(!1),[g,h]=(0,c.useState)(null);(0,c.useEffect)(()=>{new Promise((a,b)=>b(Error("No window"))).then(()=>f(!0)).catch(a=>{f(!1)})},[]);let i=async b=>{if(h(b.id),!a)return void e.default.error("Payment SDK not loaded. Please try again in a moment.");try{let a={"Content-Type":"application/json"},c=await d.default.post("https://broker-adda-be.algofolks.com/api/payments/create-order",{amount:100*b.price,planType:b.name,period:b.period});if(!c.data?.order)throw Error("Order failed");let f=c.data.order,g={key:"rzp_test_Rbx4kp6elDXWtF",amount:f.amount,currency:f.currency,name:"Broker Gully",description:`Payment for ${b.name} plan`,order_id:f.id,handler:async function(b){let f={razorpay_order_id:b.razorpay_order_id,razorpay_payment_id:b.razorpay_payment_id,razorpay_signature:b.razorpay_signature,planType:c.data.planType,period:c.data.period};try{(await d.default.post("https://broker-adda-be.algofolks.com/api/payments/verify-payment",f,{headers:a})).data.success?e.default.success("Payment successful and saved!"):e.default.error("Payment verification failed")}catch(a){e.default.error("Verification request failed")}},prefill:{name:"",email:"",contact:""}};new window.Razorpay(g).open()}catch(a){e.default.error("Payment initiation failed")}finally{h(null)}};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(e.Toaster,{position:"top-right"}),(0,b.jsx)("div",{className:"px-6 sm:px-12 lg:px-32 py-12",children:(0,b.jsx)("div",{className:"max-w-7xl mx-auto px-4 py-10",children:(0,b.jsxs)("div",{className:"mb-12",children:[(0,b.jsx)("h2",{className:"text-3xl font-semibold text-center mb-8",children:"Choose Your Subscription Plan"}),(0,b.jsx)("div",{className:"grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto",children:[{id:"basic",name:"Basic Plan",price:999,period:"month",features:["Up to 50 property listings","Basic analytics dashboard","Email support","Mobile app access","5 lead inquiries per month"],popular:!1},{id:"premium",name:"Premium Plan",price:1999,period:"month",features:["Unlimited property listings","Advanced analytics dashboard","Priority email & phone support","Mobile app access","Unlimited lead inquiries","Featured property listings","Social media integration"],popular:!0}].map(a=>(0,b.jsxs)("div",{className:`relative border rounded-xl p-6 shadow-sm bg-white transition-all hover:shadow-md ${a.popular?"border-green-900 ring-2 ring-green-900":"border-gray-200"} ${g===a.id?"ring-2 ring-green-900":""}`,children:[a.popular&&(0,b.jsx)("div",{className:"absolute -top-3 left-1/2 transform -translate-x-1/2",children:(0,b.jsx)("span",{className:"bg-green-900 text-white text-xs font-semibold px-4 py-1 rounded-full",children:"Most Popular"})}),(0,b.jsxs)("div",{className:"text-center mb-6",children:[(0,b.jsx)("h3",{className:"text-xl font-semibold mb-2",children:a.name}),(0,b.jsxs)("div",{className:"mb-4",children:[(0,b.jsxs)("span",{className:"text-3xl font-bold text-gray-900",children:["₹",a.price.toLocaleString("en-IN")]}),(0,b.jsxs)("span",{className:"text-gray-500 ml-1",children:["/",a.period]})]})]}),(0,b.jsx)("ul",{className:"space-y-3 mb-6",children:a.features.map((a,c)=>(0,b.jsxs)("li",{className:"flex items-start gap-2",children:[(0,b.jsx)("svg",{className:"w-5 h-5 text-green-900 mt-0.5 flex-shrink-0",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:(0,b.jsx)("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M5 13l4 4L19 7"})}),(0,b.jsx)("span",{className:"text-sm text-gray-700",children:a})]},c))}),(0,b.jsx)("button",{onClick:()=>i(a),className:`w-full py-3 rounded-full text-sm font-medium transition ${g===a.id||a.popular?"bg-green-900 text-white hover:bg-green-800":"border-2 border-green-900 text-green-900 hover:bg-green-50"}`,children:g===a.id?"Selected":"Select Plan"})]},a.id))})]})})})]})}}];

//# sourceMappingURL=%5Broot-of-the-server%5D__65ea6abc._.js.map