...
`,Y=({reverseOrder:a,position:b="top-center",toastOptions:d,gutter:e,children:f,toasterId:g,containerStyle:h,containerClassName:i})=>{let{toasts:j,handlers:k}=((a,b="default")=>{let{toasts:d,pausedAt:e}=((a={},b=t)=>{let[d,e]=(0,c.useState)(x[b]||w),f=(0,c.useRef)(x[b]);(0,c.useEffect)(()=>(f.current!==x[b]&&e(x[b]),v.push([b,e]),()=>{let a=v.findIndex(([a])=>a===b);a>-1&&v.splice(a,1)}),[b]);let g=d.toasts.map(b=>{var c,d,e;return{...a,...a[b.type],...b,removeDelay:b.removeDelay||(null==(c=a[b.type])?void 0:c.removeDelay)||(null==a?void 0:a.removeDelay),duration:b.duration||(null==(d=a[b.type])?void 0:d.duration)||(null==a?void 0:a.duration)||B[b.type],style:{...a.style,...null==(e=a[b.type])?void 0:e.style,...b.style}}});return{...d,toasts:g}})(a,b),f=(0,c.useRef)(new Map).current,g=(0,c.useCallback)((a,b=E)=>{if(f.has(a))return;let c=setTimeout(()=>{f.delete(a),h({type:4,toastId:a})},b);f.set(a,c)},[]);(0,c.useEffect)(()=>{if(e)return;let a=Date.now(),c=d.map(c=>{if(c.duration===1/0)return;let d=(c.duration||0)+c.pauseDuration-(a-c.createdAt);if(d<0){c.visible&&D.dismiss(c.id);return}return setTimeout(()=>D.dismiss(c.id,b),d)});return()=>{c.forEach(a=>a&&clearTimeout(a))}},[d,e,b]);let h=(0,c.useCallback)(A(b),[b]),i=(0,c.useCallback)(()=>{h({type:5,time:Date.now()})},[h]),j=(0,c.useCallback)((a,b)=>{h({type:1,toast:{id:a,height:b}})},[h]),k=(0,c.useCallback)(()=>{e&&h({type:6,time:Date.now()})},[e,h]),l=(0,c.useCallback)((a,b)=>{let{reverseOrder:c=!1,gutter:e=8,defaultPosition:f}=b||{},g=d.filter(b=>(b.position||f)===(a.position||f)&&b.height),h=g.findIndex(b=>b.id===a.id),i=g.filter((a,b)=>b<h&&a.visible).length;return g.filter(a=>a.visible).slice(...c?[i+1]:[0,i]).reduce((a,b)=>a+(b.height||0)+e,0)},[d]);return(0,c.useEffect)(()=>{d.forEach(a=>{if(a.dismissed)g(a.id,a.removeDelay);else{let b=f.get(a.id);b&&(clearTimeout(b),f.delete(a.id))}})},[d,g]),{toasts:d,handlers:{updateHeight:j,startPause:i,endPause:k,calculateOffset:l}}})(d,g);return c.createElement("div",{"data-rht-toaster":g||"",style:{position:"fixed",zIndex:9999,top:16,left:16,right:16,bottom:16,pointerEvents:"none",...h},className:i,onMouseEnter:k.startPause,onMouseLeave:k.endPause},j.map(d=>{let g=d.position||b,h=((a,b)=>{let c=a.includes("top"),d=a.includes("center")?{justifyContent:"center"}:a.includes("right")?{justifyContent:"flex-end"}:{};return{left:0,right:0,display:"flex",position:"absolute",transition:s()?void 0:"all 230ms cubic-bezier(.21,1.02,.73,1)",transform:`translateY(${b*(c?1:-1)}px)`,...c?{top:0}:{bottom:0},...d}})(g,k.calculateOffset(d,{reverseOrder:a,gutter:e,defaultPosition:b}));return c.createElement(W,{id:d.id,key:d.id,onHeightUpdate:k.updateHeight,className:d.visible?X:"",style:h},"custom"===d.type?q(d.message,d):f?f(d):c.createElement(V,{toast:d,position:g}))}))},Z=D},86286,a=>{"use strict";a.s(["default",()=>h]);var b=a.i(64144),c=a.i(75055),d=a.i(51722),e=a.i(39603),f=a.i(62768),g=a.i(36042);let h=()=>{let a=(0,e.useRouter)(),h=(0,e.useSearchParams)(),{login:i}=(0,g.useAuth)(),[j,k]=(0,c.useState)(["","","","","",""]),[l,m]=(0,c.useState)(!1),[n,o]=(0,c.useState)(0),p=(0,c.useRef)([]),q=h.get("phone");(0,c.useEffect)(()=>{p.current[0]&&p.current[0].focus()},[]),(0,c.useEffect)(()=>{let a;return n>0&&(a=setTimeout(()=>o(n-1),1e3)),()=>clearTimeout(a)},[n]);let r=a=>{a.preventDefault();let b=a.clipboardData.getData("text").replace(/\D/g,"").slice(0,6),c=[...j];for(let a=0;a<b.length&&a<6;a++)c[a]=b[a];k(c);let d=c.findIndex((a,b)=>!a&&b<6);p.current[-1!==d?d:5]?.focus()},s=async b=>{if(b.preventDefault(),(()=>{let a=j.join("");return 6!==a.length?(f.default.error("Please enter the complete 6-digit code"),!1):!!/^\d{6}$/.test(a)||(f.default.error("Code must contain only numbers"),!1)})()){m(!0);try{let b=j.join(""),c=h.get("phone"),d=await fetch("https://broker-adda-be.fly.dev/api/auth/verify-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:c,otp:b})}),e=await d.json().catch(()=>({}));if(d.ok&&(void 0===e.success||!0===e.success)){let b=e?.role||e?.user?.role||e?.data?.role||"",d=e?.token||e?.data?.token,g=e?.phone||e?.data?.phone||c,h=e?.userId||e?.data?.userId;if(!d)throw Error("No authentication token received from server");try{let a=d.split(".");if(3!==a.length)throw Error("Invalid token format");let b=JSON.parse(atob(a[1])),c=Math.floor(Date.now()/1e3);if(b.exp&&b.exp<c)throw Error("Token has expired")}catch(a){throw Error("Invalid authentication token received")}if(i({token:d,phone:g,role:b,userId:h}),!localStorage.getItem("token"))throw Error("Failed to save authentication token");f.default.success("Verification successful! Redirecting..."),"broker"===b?a.push("/myaccount"):a.push("/customer-profile?mode=view")}else f.default.error(e.message||`Verification failed (${d.status})`)}catch(a){f.default.error(a.message||"Verification failed. Please try again.")}finally{m(!1)}}},t=async()=>{o(60);try{let a=await fetch("https://broker-adda-be.fly.dev/api/auth/resend-otp",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({phone:h.get("phone")})});if(a.ok)await a.json(),f.default.success("Verification code sent successfully!");else{let b=await a.json().catch(()=>({message:"Unknown error"}));f.default.error(b.message||`Failed to resend code (${a.status})`)}}catch(a){f.default.error("Network error. Please try again.")}};return(0,b.jsxs)(b.Fragment,{children:[(0,b.jsx)(f.Toaster,{position:"top-right",toastOptions:{duration:4e3,style:{background:"#363636",color:"#fff"},success:{duration:3e3,iconTheme:{primary:"#4ade80",secondary:"#fff"}},error:{duration:4e3,iconTheme:{primary:"#ef4444",secondary:"#fff"}}}}),(0,b.jsxs)("div",{className:"min-h-screen py-6 md:py-8 lg:py-12 flex",children:[(0,b.jsx)("div",{className:"flex-1 flex items-center justify-center px-4 md:px-6 py-6 md:py-8 lg:py-12 bg-white",children:(0,b.jsxs)("div",{className:"w-full max-w-md",children:[(0,b.jsxs)("div",{className:"mb-6 md:mb-8",children:[(0,b.jsx)("div",{className:"text-left mb-3 md:mb-4",children:(0,b.jsxs)(d.default,{href:"/login",className:"flex items-center gap-2 text-sm md:text-base text-gray-600 hover:text-green-900 font-medium",children:[(0,b.jsx)("svg",{width:"20",height:"20",className:"md:w-6 md:h-6",viewBox:"0 0 24 24",fill:"none",xmlns:"http://www.w3.org/2000/svg",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:(0,b.jsx)("path",{d:"M15 18L9 12l6-6"})}),"Back to Login"]})}),(0,b.jsx)("h1",{className:"text-2xl md:text-3xl font-bold text-gray-900 mb-2",children:"Verify Code"}),(0,b.jsx)("p",{className:"text-sm md:text-base text-gray-600",children:"Please enter the code we just sent to your phone number"}),(0,b.jsx)("p",{className:"text-sm md:text-base text-green-900 font-medium mt-2",children:q})]}),(0,b.jsxs)("form",{onSubmit:s,className:"space-y-4 md:space-y-6",children:[(0,b.jsxs)("div",{children:[(0,b.jsx)("label",{className:"block text-xs md:text-sm font-medium text-gray-900 mb-3 md:mb-4",children:"Code *"}),(0,b.jsx)("div",{className:"flex space-x-2 md:space-x-3",children:j.map((a,c)=>(0,b.jsx)("input",{ref:a=>p.current[c]=a,type:"text",inputMode:"numeric",maxLength:"1",value:a,onChange:a=>((a,b)=>{if(b.length>1)return;let c=[...j];c[a]=b,k(c),b&&a<5&&p.current[a+1]?.focus()})(c,a.target.value),onKeyDown:a=>((a,b)=>{"Backspace"===b.key&&!j[a]&&a>0&&p.current[a-1]?.focus()})(c,a),onPaste:r,className:"w-10 h-10 md:w-12 md:h-12 text-center text-lg md:text-xl font-bold border-2 border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-colors"},c))})]}),(0,b.jsx)("button",{type:"submit",disabled:l,className:"w-full bg-green-900 text-white py-2.5 md:py-3 px-4 rounded-full text-sm md:text-base font-medium hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed",children:l?"Verifying...":"Verify"}),(0,b.jsx)("div",{className:"text-center",children:(0,b.jsxs)("p",{className:"text-sm md:text-base text-gray-600",children:["Didn't receive code?"," ",n>0?(0,b.jsxs)("span",{className:"text-gray-400",children:["Resend in ",n,"s"]}):(0,b.jsx)("button",{type:"button",onClick:t,className:"text-green-900 hover:text-green-800 font-medium underline",children:"Resend OTP"})]})})]})]})}),(0,b.jsx)("div",{className:"hidden lg:flex lg:flex-1 relative",children:(0,b.jsxs)("div",{className:"w-[650px] h-[800px] rounded-2xl overflow-hidden relative",children:[(0,b.jsx)("img",{src:"/images/realestate.png",alt:"Modern Interior",className:"w-full h-full object-cover",onError:a=>{a.target.style.display="none",a.target.nextElementSibling.style.display="block"}}),(0,b.jsx)("div",{className:"absolute bottom-20 left-6 right-4",children:(0,b.jsxs)("div",{className:" bg-opacity-20 backdrop-blur-md border border-white border-opacity-30 rounded-2xl p-6 w-[600px] shadow-2xl",children:[(0,b.jsx)("p",{className:"text-white text-base leading-relaxed mb-4",children:'"Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore."'}),(0,b.jsxs)("div",{className:"space-y-1",children:[(0,b.jsx)("h4",{className:"text-white font-semibold text-base",children:"Annette Black"}),(0,b.jsx)("p",{className:"text-white text-sm",children:"Architecture"})]})]})}),(0,b.jsxs)("div",{className:"absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2",children:[(0,b.jsx)("div",{className:"w-32 h-2 bg-white bg-opacity-20 backdrop-blur-md rounded-full"}),(0,b.jsx)("div",{className:"w-32 h-2 bg-white bg-opacity-20 backdrop-blur-md rounded-full"}),(0,b.jsx)("div",{className:"w-32 h-2 bg-orange-400 rounded-full"}),(0,b.jsx)("div",{className:"w-32 h-2 bg-white bg-opacity-20 backdrop-blur-md rounded-full"})]})]})})]})]})}}];

//# sourceMappingURL=Desktop_Broker%20adda_broker-adda-web_79e0e3eb._.js.map