                ...
                {[
                  ...
                  <div key={doc.name} className="flex items-center justify-between rounded-2xl border border-gray-200 bg-white px-4 py-3 shadow-sm">
                    <div>
                      ...
                      {doc.verified && (
                        <div className="mt-1 inline-flex items-center gap-2 text-sm text-emerald-600">
                    ...
                    <button className="inline-flex items-center justify-center rounded-full bg-emerald-100 text-emerald-700 px-4 py-2 text-sm font-medium hover:bg-emerald-200">
                      View
                    </button>
                  </div>
                ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">linkedin.com/in/nehamehta</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200">
                  <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center">
                ...
                <div>
                    ...
                    <div className="text-sm text-gray-600">@neha.mehta</div>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-lg border border-gray-200">
