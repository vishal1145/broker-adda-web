...
const PropertyFormPage = ({ propertyId = null, isEditMode = false }) => {
  ...
  const canNavigateToStep = (step) => {
    ...
    // Forward navigation requires previous steps to be valid
                ...
                <div className="mb-4">
                  <div className="flex items-center justify-between">
                    {Array.from({ length: totalSteps }, (_, i) => i + 1).map((step, idx) => {
                      ...
                      const allowed = canNavigateToStep(step);
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="relative">
                              <select
                                ...
                                onChange={handleChange}
                                className="w-full border border-gray-300 rounded-xl text-[13px] px-3 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-transparent transition-all duration-200 appearance-none"
                                required
                              >
                          ...
                          {amenityPresetOptions.map((preset) => {
                            ...
                            return (
                              <button
                                ...
                                className={`px-3 py-1.5 rounded-full text-[12px] border transition-colors ${isSelected
