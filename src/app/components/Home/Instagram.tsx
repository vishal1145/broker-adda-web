...
const Instagram = ({ data = { subtitle: '', title: '', images: [] } }: { data: InstagramData }) => {
  ...
  return (
    <section className="py-12 md:py-16">
      ...
      <div
        ref={scrollRef}
        className="flex gap-3 md:gap-4 mx-auto overflow-x-auto scrollbar-hide"
        style={{ 
      ...
      >
        {(images || []).map((image, index) => (
          <div
            key={index}
            className="relative rounded-2xl overflow-hidden flex-shrink-0 w-[140px] h-[140px] md:w-[220px] md:h-[220px]"
          >
            {image ? (
              <Image
                src={image}
