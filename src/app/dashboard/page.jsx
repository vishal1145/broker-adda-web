...
const Dashboard = () => {
        ...
        <div className="w-full mx-auto px-4 md:px-0">
          ...
          <div className="mb-8 pb-16">
            ...
            >
              <div className="px-6 pt-6 pb-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-[14px] leading-[20px] font-medium" style={{ fontFamily: 'Inter', color: '#565D6DFF' }}>Total Enquires</div>
            ...
            >
              <div className="px-6 pt-6 pb-4">
                <div className="flex items-center justify-between mb-4">
                  <div className="text-[14px] leading-[20px] font-medium" style={{ fontFamily: 'Inter', color: '#565D6DFF' }}>Total Closed Enquires</div>
                  <div className="w-5 h-5 flex items-center justify-center">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: '#565D6DFF' }}>
          ...
          <div className="mb-8 pb-16">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-[18px] font-bold text-gray-900">Recent Enquires</h2>
              <button
                onClick={() => router.push('/leads')}
              ...
              <div className="w-full">
                ...
                >
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    <span className="text-lg font-semibold text-gray-600">No recent enquires found</span>
                  </div>
                </button>
              </div>
            )}
  ...
  {propertiesLoading ? (
    <div className="flex flex-col md:flex-row gap-4">
      {/* left: Add Property */}
      <div className="flex-none w-full md:w-[220px] h-[260px] border-2 border-dashed border-gray-300 rounded-xl animate-pulse bg-gray-100"></div>
