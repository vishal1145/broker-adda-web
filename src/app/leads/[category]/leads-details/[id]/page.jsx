...
export default function LeadDetails() {
  ...
  const similarLeads = async () => {
    try {
      ...
      setSameLeads(response.data.data.items);
    } catch (error) {
                    ...
                    <div className="sm:col-span-2 bg-gray-50 rounded-xl p-4 border border-gray-100">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {["Downtown", "Riverside", "Green Park"].map(
                              (loc) => (
                                <span
                                  key={loc}
                  ...
                  {sameLeads.length === 0 ? (
                    ...
                    sameLeads
                      ...
                      .map((s) => (
                        <a
                          key={s._id}
                          href={`/leads/${s.propertyType}/leads-details/${s._id}`} // dynamic link
