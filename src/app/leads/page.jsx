...
const LeadsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="w-80 flex-shrink-0">
            <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
                ...
                <div className="relative">
                  <div className="w-full h-2 bg-gray-200 rounded-lg relative">
                    <div 
                      ...
                      style={{
                        left: `${((filters.budgetRange[0] - 1000000) / (20000000 - 1000000)) * 100}%`,
                        width: `${100 - ((filters.budgetRange[0] - 1000000) / (20000000 - 1000000)) * 100}%`
                      }}
                    ></div>
                  <input
                    type="range"
              ...
              {/* Broker/Agent Filter */}
                ...
                <select
                  value={filters.brokerAgent}
                  onChange={(e) => setFilters(prev => ({ ...prev, brokerAgent: e.target.value }))}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
      ...
      {/* Public Viewer Indicator */}
      <div className="fixed bottom-0 left-0 right-0 bg-gray-800 bg-opacity-90 text-white px-4 py-3 flex items-center justify-between">
